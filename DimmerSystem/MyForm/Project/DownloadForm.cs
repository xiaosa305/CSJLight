...
{
    public partial class DownloadForm : UIForm
    {
		private MainFormBase mainForm;
		private string exportProjectPath;

		public DownloadForm(MainFormBase mainForm)
		{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void exportedCheckBox_CheckedChanged(object sender, EventArgs e)
		{
			refreshButtons();
		...
		public void DrawProgress(string fileName, int progressPercent)
		{
			...
			myProcessBar.Value = progressPercent;
		}
