...
{
    public partial class DetailMultiAstForm : UIForm
    {
		...
		public DetailMultiAstForm(MainFormBase mainForm)
		{
			...
			for (int lightIndex = 0; lightIndex < mainForm.LightAstList.Count; lightIndex++)
			{
				...
				Panel lightPanel = new Panel
				{
					...
					Tag = lightIndex,
					BorderStyle = lightPanelDemo.BorderStyle
				};
				...
				Label lightLabel = new Label
				{
					...
					Tag = lightIndex,
					ForeColor = lightLabelDemo.ForeColor,
					BackColor = lightLabelDemo.BackColor,
					AutoSize = lightLabelDemo.AutoSize,
				};
				...
				CheckBox allCheckBox = new CheckBox
				{
					...
					Tag = lightIndex,
					ForeColor = allCheckBoxDemo.ForeColor,
					BackColor = allCheckBoxDemo.BackColor,
				};
				...
				FlowLayoutPanel lightFLP = new FlowLayoutPanel
				{
					...
					Tag = lightIndex,
					BackColor = lightFLPDemo.BackColor,
				};
				...
				for (int tdIndex = 0; tdIndex < tongdaoList.Count; tdIndex++)
				{
					CheckBox tdCheckBox = new CheckBox
					{
						...
						BackColor = tdCheckBoxDemo.BackColor,
					};
		...
		private void groupComboBox_SelectedIndexChanged(object sender, EventArgs e)
		{
            ...
            {
                (bigFLP.Controls[panelIndex] as Panel).BackColor = lightPanelDemo.BackColor ;
            }
            ...
            {
				(bigFLP.Controls[lightIndex + 1] as Panel).BackColor = Color.DarkSlateGray;
            }
        }
