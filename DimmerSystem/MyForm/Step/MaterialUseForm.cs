...
{
    public partial class MaterialUseForm : UIForm
    {
		...
		private void MaterialUseForm_Load(object sender, EventArgs e)
		{
			...
			{
				IniHelper iniHelper = new IniHelper(mainForm.GetConfigPath());
		...
		private void useMaterialButton_Click(object sender, EventArgs e)
		{
			if (generateComplexMaterial())
			{
				...
				//DOTO mainForm.UseMaterial(complexMaterial, insMethod, false);
		...
		private void tdAddButton_Click(object sender, EventArgs e)
		{
			...
			UIButton tdDelButton = new UIButton
			{
				Location = tdDelButtonDemo.Location,
				Size = tdDelButtonDemo.Size,
				Text = "-",
				Cursor = tdDelButtonDemo.Cursor,
				FillColor = tdDelButtonDemo.FillColor,
				FillDisableColor = tdDelButtonDemo.FillDisableColor,
				FillHoverColor = tdDelButtonDemo.FillHoverColor,
				FillPressColor = tdDelButtonDemo.FillPressColor,
				FillSelectedColor = tdDelButtonDemo.FillSelectedColor,
				Font = tdDelButtonDemo.Font,
				ForeDisableColor = tdDelButtonDemo.ForeDisableColor,				
				MinimumSize = tdDelButtonDemo.MinimumSize,
				RectColor = tdDelButtonDemo.RectColor,
				RectDisableColor = tdDelButtonDemo.RectDisableColor,
				RectHoverColor = tdDelButtonDemo.RectHoverColor,
				RectPressColor = tdDelButtonDemo.RectPressColor,
				RectSelectedColor = tdDelButtonDemo.RectSelectedColor,				
				Style = tdDelButtonDemo.Style,
			};
