...
namespace LightController.MyForm
{
	partial class NewMainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lightImageList.Images.SetKeyName(0, "1.jpg");
			this.lightImageList.Images.SetKeyName(1, "3.jpg");
			this.lightImageList.Images.SetKeyName(2, "4.jpg");
			this.lightImageList.Images.SetKeyName(3, "5.jpg");
			this.lightImageList.Images.SetKeyName(4, "60w.jpg");
			this.lightImageList.Images.SetKeyName(5, "a (1).jpg");
			this.lightImageList.Images.SetKeyName(6, "a (1).png");
			this.lightImageList.Images.SetKeyName(7, "a (2).jpg");
			this.lightImageList.Images.SetKeyName(8, "a (2).png");
			this.lightImageList.Images.SetKeyName(9, "A500--500MW全彩动画激光灯.png");
			this.lightImageList.Images.SetKeyName(10, "A520--梦幻星空灯.png");
			this.lightImageList.Images.SetKeyName(11, "A1500--1.5W全彩动画激光灯.png");
			this.lightImageList.Images.SetKeyName(12, "A2000--2W全彩动画激光灯.png");
			this.lightImageList.Images.SetKeyName(13, "D08--六眼扫描激光灯.png");
			this.lightImageList.Images.SetKeyName(14, "D20--摇头染色灯.png");
			this.lightImageList.Images.SetKeyName(15, "D30G--染色激光灯.png");
			this.lightImageList.Images.SetKeyName(16, "D50S--染色图案灯.png");
			this.lightImageList.Images.SetKeyName(17, "E12--无极剑.png");
			this.lightImageList.Images.SetKeyName(18, "E18--嵌入式18颗帕灯.png");
			this.lightImageList.Images.SetKeyName(19, "E20--大蝴蝶灯.png");
			this.lightImageList.Images.SetKeyName(20, "E30--无极魔球灯.png");
			this.lightImageList.Images.SetKeyName(21, "E60--峰眼激光灯.png");
			this.lightImageList.Images.SetKeyName(22, "E70G--染色激光灯.png");
			this.lightImageList.Images.SetKeyName(23, "E80--染色图案灯.png");
			this.lightImageList.Images.SetKeyName(24, "E300--嵌入式红绿蓝图案激光灯.png");
			this.lightImageList.Images.SetKeyName(25, "E500--500MW嵌入式全彩激光灯.png");
			this.lightImageList.Images.SetKeyName(26, "F05--摇头峰眼灯.png");
			this.lightImageList.Images.SetKeyName(27, "j(1).png");
			this.lightImageList.Images.SetKeyName(28, "j(2).png");
			this.lightImageList.Images.SetKeyName(29, "j(3).png");
			this.lightImageList.Images.SetKeyName(30, "j(4).png");
			this.lightImageList.Images.SetKeyName(31, "j(5).png");
			this.lightImageList.Images.SetKeyName(32, "j(6).png");
			this.lightImageList.Images.SetKeyName(33, "j(7).png");
			this.lightImageList.Images.SetKeyName(34, "j(8).png");
			this.lightImageList.Images.SetKeyName(35, "j(9).png");
			this.lightImageList.Images.SetKeyName(36, "j(10).png");
			this.lightImageList.Images.SetKeyName(37, "j(11).png");
			this.lightImageList.Images.SetKeyName(38, "P05--调焦染色灯.png");
			this.lightImageList.Images.SetKeyName(39, "S60--60W三棱镜图案灯.png");
			this.lightImageList.Images.SetKeyName(40, "T90-90W八凌镜光束灯.png");
			this.lightImageList.Images.SetKeyName(41, "灯光图.png");
			// 
			// stepBasePanel
			// 
