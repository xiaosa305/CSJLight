...
namespace LightController.MyForm.Project
{
    public partial class OpenForm : UIForm
    {
		...
		{
			sortMethod = EnumSortMethod.FILE_NAME;
			RefreshDirTreeView();
		}
		...
		{
			sortMethod = EnumSortMethod.CREATION_TIME;
			RefreshDirTreeView();
		}
		...
		{
			sortMethod = EnumSortMethod.LAST_WRITE_TIME;
			RefreshDirTreeView();
		}
		...
		internal void RefreshDirTreeView()
		{
			...
			if (Directory.Exists(path))
			{
				...
				switch (sortMethod)
				{
					case EnumSortMethod.CREATION_TIME: DirectoryHelper.SortAsFolderByCreationTime(ref diArray); break;
					case EnumSortMethod.LAST_WRITE_TIME: DirectoryHelper.SortAsFolderByLastWriteTime(ref diArray); break;
					default: break;
				}
