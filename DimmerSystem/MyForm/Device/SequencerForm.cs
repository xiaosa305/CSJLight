...
{
    public partial class SequencerForm : UIForm
    {
		...
		private UIImageButton[] relayButtons;
		private UITextBox[] relayTBs;
		...
		public SequencerForm(MainFormBase mainForm)
		{
			...
			relayButtons = new UIImageButton[relayCount];
			relayTBs = new UITextBox[relayCount];
			...
			for (int relayIndex = 0; relayIndex < relayCount; relayIndex++)
			{
				...
				relayButtons[relayIndex] = new UIImageButton
				{
					...
					Cursor = relayButtonDemo.Cursor ,
					Font = relayButtonDemo.Font ,
					ForeColor = relayButtonDemo.ForeColor ,
					Image = relayButtonDemo.Image ,
					ImageDisabled = relayButtonDemo.ImageDisabled ,
					ImageHover = relayButtonDemo.ImageHover ,
					ImageOffset = relayButtonDemo.ImageOffset ,
					ImageSelected = relayButtonDemo.ImageSelected ,
					Location = relayButtonDemo.Location ,
					Size = relayButtonDemo.Size ,
					TabStop = relayButtonDemo.TabStop,
					TextAlign = relayButtonDemo.TextAlign ,	
					Visible = true,
					Name = "relayButtons" + (relayIndex + 1),
					Text = LanguageHelper.TranslateWord("开关") + (relayIndex + 1)
				};
								
				relayTBs[relayIndex] = new UITextBox
				{
					BackColor = relayTextBoxDemo.BackColor ,
					ButtonSymbol = relayTextBoxDemo.ButtonSymbol ,
					Cursor = relayTextBoxDemo.Cursor ,
					FillColor = relayTextBoxDemo.FillColor ,
					Font = relayTextBoxDemo.Font ,
					Location = relayTextBoxDemo.Location,
					Margin = relayTextBoxDemo.Margin ,
					Padding = relayTextBoxDemo.Padding ,
					Radius = relayTextBoxDemo.Radius ,
					Size = relayTextBoxDemo.Size ,
					Style = relayTextBoxDemo.Style ,
					TextAlignment = relayTextBoxDemo.TextAlignment ,
				};
			...
			for (int timeIndex = 0; timeIndex < relayCount - 1; timeIndex++)
			{
				...
				{
					Font = timeNUDDemo.Font ,
					Location = timeNUDDemo.Location,
					Margin = timeNUDDemo.Margin ,
				...
				relayFLP.Controls.Add(timeNUDs[timeIndex]);
			}
		}
		...
		public void OpenSceneCompleted(Object lcDataTemp, string msg)
		{
			Invoke((EventHandler)delegate {
				...
				for (int relayIndex = 0; relayIndex < relayCount; relayIndex++)
				{
					relayButtons[relayIndex].Selected = true;
					Refresh();
		...
		public void CloseSceneCompleted(Object lcDataTemp, string msg)
		{
			Invoke((EventHandler)delegate {
				...
				{
					relayButtons[relayIndex].Selected = false;
					Refresh();
					relayIndex--;
					if (relayIndex >= 0)
					{
