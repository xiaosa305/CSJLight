namespace LightEditor
{
	partial class NewLightEditorForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tdTextBoxDemo = new System.Windows.Forms.TextBox();
			...
			this.saveLightButton.TabIndex = 11;
			this.saveLightButton.Text = "保存灯具";
			this.saveLightButton.UseVisualStyleBackColor = false;
			...
			this.openLightButton.TabIndex = 10;
			this.openLightButton.Text = "打开灯具";
			this.openLightButton.UseVisualStyleBackColor = false;
			...
			this.newLightButton.TabIndex = 9;
			...
			this.picTextBox.Size = new System.Drawing.Size(128, 21);
			this.picTextBox.TabIndex = 16;
			// 
			// typeTextBox
			// 
			...
			this.tongdaoCountLabel.TabIndex = 20;
			...
			this.countComboBox.TabIndex = 18;
			...
			// nameListBox
			// 
			this.nameListBox.BackColor = System.Drawing.Color.Gray;
			...
			this.nameListBox.ForeColor = System.Drawing.SystemColors.HighlightText;
			...
			this.noticePanel.Dock = System.Windows.Forms.DockStyle.Top;
			this.noticePanel.Location = new System.Drawing.Point(0, 0);
			this.noticePanel.Name = "noticePanel";
			this.noticePanel.Size = new System.Drawing.Size(164, 48);
			this.noticePanel.TabIndex = 3;
			// 
			// noticeLabel
			// 
			this.noticeLabel.ForeColor = System.Drawing.SystemColors.ControlLightLight;
			this.noticeLabel.Location = new System.Drawing.Point(8, 9);
			this.noticeLabel.Margin = new System.Windows.Forms.Padding(2, 0, 2, 0);
			this.noticeLabel.Name = "noticeLabel";
			this.noticeLabel.Size = new System.Drawing.Size(141, 37);
			...
			this.tdPanelDemo.Size = new System.Drawing.Size(86, 210);
			...
			this.tdTrackBarDemo.BackColor = System.Drawing.Color.PowderBlue;
			this.tdTrackBarDemo.Location = new System.Drawing.Point(35, 30);
			...
			this.tdTrackBarDemo.Size = new System.Drawing.Size(35, 142);
			...
			// tdTextBoxDemo
			// 
			this.tdTextBoxDemo.Location = new System.Drawing.Point(3, 7);
			this.tdTextBoxDemo.Margin = new System.Windows.Forms.Padding(2);
			this.tdTextBoxDemo.Name = "tdTextBoxDemo";
			this.tdTextBoxDemo.Size = new System.Drawing.Size(81, 21);
			this.tdTextBoxDemo.TabIndex = 15;
			this.tdTextBoxDemo.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.tdTextBoxDemo.MouseClick += new System.Windows.Forms.MouseEventHandler(this.tdTextBoxes_MouseClick);
			// 
			// tdNUDDemo
			// 
			...
			this.tdLabelDemo.Size = new System.Drawing.Size(14, 72);
			this.tdLabelDemo.TabIndex = 13;
			...
			// lightGroupBox
			// 
			this.lightGroupBox.Controls.Add(this.nameLabel);
			this.lightGroupBox.Controls.Add(this.typeLabel);
			this.lightGroupBox.Controls.Add(this.picLabel);
			this.lightGroupBox.Controls.Add(this.countComboBox);
			this.lightGroupBox.Controls.Add(this.tongdaoCountLabel);
			this.lightGroupBox.Controls.Add(this.nameTextBox);
			this.lightGroupBox.Controls.Add(this.typeTextBox);
