...
namespace LightController.MyForm
{
	partial class SkinMainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.testGroupBox.Location = new System.Drawing.Point(963, 8);
			...
			this.flowLayoutPanel1.Size = new System.Drawing.Size(947, 100);
			...
			this.tdCommonPanel.Controls.Add(this.groupButton);
			this.tdCommonPanel.Controls.Add(this.multiButton);
			...
			this.deleteStepSkinButton.MouseDown += new System.Windows.Forms.MouseEventHandler(this.deleteStepSkinButton_MouseDown);
			// 
			// addStepSkinButton
			// 
