...
{
	public partial class NewSAForm : Form
	{
		public NewLightEditorForm leForm;
		private int saIndex = -1;

		public NewSAForm(NewLightEditorForm leForm, int saIndex, string saName, int startValue, int endValue)
		{
			this.leForm = leForm;
		...
		private void NewSAForm_Load(object sender, EventArgs e)
		{
		...
		private void enterButton_Click(object sender, EventArgs e)
		{
			...
			if (saIndex == -1)
			{
				leForm.AddSAPanel(saNameTextBox.Text.Trim(), Decimal.ToInt32(startValueNumericUpDown.Value), Decimal.ToInt32(endValueNumericUpDown.Value));
				leForm.AddSA(new SA()
				{
			...
			{
				leForm.EditSA(saIndex, saNameTextBox.Text, Decimal.ToInt32(startValueNumericUpDown.Value), Decimal.ToInt32(endValueNumericUpDown.Value));
			}
			Exit();
		}
