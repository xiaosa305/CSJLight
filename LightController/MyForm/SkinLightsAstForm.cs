...
{
	public partial class SkinLightsAstForm : System.Windows.Forms.Form
	{
		public SkinLightsForm lightsForm; // 存储一个对LightsForm的引用
		...
		public SkinLightsAstForm(SkinLightsForm lightsForm, string lightPath, int startNum)
		{
			InitializeComponent();
