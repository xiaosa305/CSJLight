...
{
    public partial class DMX512ConnectForm : UIForm
    {
		private MainFormBase mainForm;

		public DMX512ConnectForm(MainFormBase mainForm)
		{
			InitializeComponent();
			this.mainForm = mainForm;
		}

		private void DMX512ConnectForm_Load(object sender, EventArgs e)
		{
