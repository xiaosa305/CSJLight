...
{
	public partial class SkinLightsEditForm : Form
	{
		private SkinLightsForm lightsForm;
		private LightAst lightAst;
		private int lightIndex;

		public SkinLightsEditForm(SkinLightsForm lightsForm, LightAst lightAst,int lightIndex)
		{
			InitializeComponent();
